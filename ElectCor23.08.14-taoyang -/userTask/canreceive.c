...
uint8_t variant_Canreceive_STATE = 0x10;//控制器状态   传递命令变量  创建人蒋博 创建日期2023/08/18
...
//		case   BUS_COMPUTER_CHOSE:
//			if(_variant_Mainlogic_statement.PRESENTstate_value == State_Mainlogic_DWFAULTstate)
//			{

//				_variant_Mainlogic_statement.PRESENTstate_value = CONTROLED;
//				State_main_TrumpetStatus = 1;
//				State_main_LEDStatus = 0;
//			}
//		break;
		case   BUS_COMPUTER_MOVE:
			if(( _variant_Mainlogic_statement.PRESENTstate_value == State_Mainlogic_DWFAULTstate)&&(array_Canreceive_CanBUScmdR[1] == Structset_Service_DeviceNum1_1.Setting_Para))
			{
				_variant_Mainlogic_statement.PRESENTstate_value = CONTROLED;
