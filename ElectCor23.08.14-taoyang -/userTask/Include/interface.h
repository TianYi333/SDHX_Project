...
extern char variant_interface_Dive[7];//������ͨ����ʾ


/***********************_variant_Interface_disp.type�ã�������Ļ��ʾ***********************************/
...
/***********************_variant_Interface_disp.upright��***********************************/
...
#define   CURSOR_TYPE_SETTING_AUTOMATION_LIMT   6
#define   CURSOR_TYPE_SETTING_FAULT_LIMT   11

struct _disp_menu{	
	
	uint8_t		  cursor;					//��ʾ��Ŀ����  ֻ��123����
    uint8_t       type; 
};


typedef struct _disp_context{
	unsigned char page_y;						//����y
	unsigned char column_x;						//����x
    char *Use_Char;						//����
}_disp_context;
...
extern char variant_interface_SingalMove[11];//����������ʾ�ַ��������
...
extern char variant_interface_Grouptail[4];//����ܺ�β
extern char variant_interface_Grouphead[4];//����ܺ�ͷ
extern char variant_interface_arrows[4];//�����ͷ
extern char variant_interface_move[7];//���鶯��
#endif
