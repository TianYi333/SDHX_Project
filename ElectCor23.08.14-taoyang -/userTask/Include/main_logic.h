...
#define   URGENCY_STOP    0x00    //急停
#define   NORMOL_IDLE     0x01    //普通空闲
#define   AUTO_IDLE       0x02    //跟机空闲
#define   SETTING       0x03      //主控
#define   CONTROLED       0x04    //被控
#define   GROUP_CONTROLED       0x07   //成组被控
#define   FREEZE       0x05     //成组暂停
#define   MOVE       0x06       //成组动作
#define   URGENCY_LOCK       0x0a      //闭锁
...
#define   MOVE_HYDRAULICFRAME_ADVANCING_OUT                  (1<<20)          //移架
#define   MOVE_CHUTE_PUSH_OUT                                (1<<21)         //推溜
#define   MOVE_BOTTOM_UP_OUT      	                       0        //抬底
#define   MOVE_FUEL_SPRAY_OUT                                (1<<9)            //喷雾
#define   MOVE_BALANCE_BEAM_STRETCH_OUT                        (1<<19)            //伸平衡梁
#define   MOVE_BALANCE_BEAM_WITHDRAW_OUT                         (1<<18)            	//收平衡梁
#define   MOVE_SIDE_PLATE_STRETCH_OUT                         (1<<17)           //伸侧推
#define   MOVE_SIDE_PLATE_WITHDRAW_OUT                        (1<<16)           //收侧推
#define   MOVE_TELESCOPIC_GIRDER_STRETCH_OUT                  0          //伸伸缩梁
#define   MOVE_TELESCOPIC_GIRDER_WITHDRAW_OUT                 0            //收伸缩梁
#define   MOVE_PLATE_STRETCH_OUT                              0            //伸护帮板
#define   MOVE_PLATE_WITHDRAW_OUT                             0            //收护帮板
#define   MOVE_HYDRAULIC_BOTTOM_STRETCH_OUT               (1<<13)           //伸底调
#define   MOVE_HYDRAULIC_BOTTOM_WITHDRAW_OUT              (1<<12)           //收底调
#define   MOVE_STANDBY_APPLICATION1_OUT                  (1<<8)             //备用动作1
#define   MOVE_STANDBY_APPLICATION2_OUT                       0           //备用动作2
