...
/***********************显示页面分类***********************************/
 ...
 struct _disp_context default_page[12] = {
	...
	{page_Third_Line, column_1_Line, "底座角度:       "},
	{page_Third_Line, column_10_Line, _sensor_Foundation_angle.sensor_view},	
...
static struct _disp_context Singal_move[5] = {
                                    //0123456789abcdef/
...
struct _disp_context setting_AUTOMATION[9] = {
                     //0123456789abcdef/
	{0, column_1_Line,"      跟机      "},
	...
	{5, column_1_Line, "跟机工艺        "},
	{5, column_13_Line, Structset_Follow_craft3_6.Setting_Char},
          ...
          else
          {
            Display_context_show(Bus_move,5,0,0);
				...
				case TYPE_SETTING_AUTOMATION:
					Display_context_show(setting_AUTOMATION,9,1,5);
					break;
